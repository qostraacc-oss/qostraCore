...
class CoreUserSyncService(BaseUserSyncService):
    """
    Core User Sync Service.
    Maps user information from the QostraAuth JWT token to the local User model.
    Located in common/auth/ to prevent circular dependencies.
    """
    ...
    def sync_user(self, user_id, token_payload):
        ...
        # Use UUID user_id as the primary key (id)
...
core_user_sync_service = CoreUserSyncService()
# Alias for backward compatibility
workspace_user_sync_service = core_user_sync_service
